...
feature: 2026-05-01-roadmap-risk-split
status: draft
summary: Roadmap risk split
tags: []
---
...
- 路由说明: src/components/RiskSplitA.tsx -> frontend
- 路由说明: src/components/RiskSplitB.tsx -> frontend
- 路由说明: src/components/RiskSplitC.tsx -> frontend
- 路由说明: backend/api/risk-split-a.ts -> backend
- 路由说明: backend/api/risk-split-b.ts -> backend
- 路由说明: backend/api/risk-split-c.ts -> backend
